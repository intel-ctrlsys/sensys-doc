...
component:genex:args:msg_regex=access granted,severity=info;notifier=smtp

* nodelist: Specifies the list of nodes in which the workflow will be tracked.
* component:filter:args:data_group: A sensor list which will interact with the analytics framework, this list is separated by a semicolon. i.e. “syslog;freq;coretemp”
* component:genex:args: These ares the arguments set for a given sensor. Arguments can change depending on which sensor is specified, for syslog sensor you can specify the following arguments:

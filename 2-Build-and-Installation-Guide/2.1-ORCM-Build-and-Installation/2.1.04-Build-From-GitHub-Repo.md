...
Following are the steps for building gemeter from the github repo. Before building create an account in the github. Clone the gemeter repo from the github branch.
```
shell$ git clone https://github.com/orcmteam/gemeter
-or- 
shell$ git clone https://<username>@github.com/orcmteam/gemeter

Admin-focused tool for interacting with ORCM.  This tool has the ability to run as an interactive shell or as a single one-shot command.  Currently the tool provides information about configured resources, queues, sensors and, allows to modify the workflows of ORCM.
...
#### 3.1.1.6 Sensor Inventory Listing
...
#### 3.1.1.7 Sensor Sample Rate Listing
...
#### 3.1.1.8 Sensor Sample Rate Setting

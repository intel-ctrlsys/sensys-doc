...
The ''sensor_search_string'' at this time is limited to searching the stored plugin names.  Valid formats include omitting the parameter to get <b>all</b> sensors matching the regex or logical name.  Using '*' for <i>sensor_search_string</i> does  the same action as omitting <i>sensor_search_string</i>.

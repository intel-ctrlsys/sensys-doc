...
To store Event data:
**$ OCTL sensor store event\_only nodelist
...
* NOTIFIER:
    - SYNTAX:
        ```sh
        notifer set policy <severity> <action> <nodelist>
        ```
...
* NOTIFIER:
    - SYNTAX:
        ```sh
        notifer set smtp-policy <key> <value> <nodelist>
        ```
    - USE: Returns success - when operation is successful or Returns failed - with an error message.
    - EXAMPLE:
        ```sh
...
* NOTIFIER:
    - SYNTAX:
        ```sh
        notifer get smtp-policy <nodelist>
        ```
    - USE: Returns success - when operation is successful or Returns failed - with an error message.
    - EXAMPLE:
        ```sh

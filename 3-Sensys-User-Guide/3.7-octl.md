...
Storage control is designed to control environmental(raw) and event data. There are couple of MCA parameters provided to control them respectively. analytics\_base\_store\_raw\_data controls environmental data and analytics\_base\_store\_event\_data controls event data.
